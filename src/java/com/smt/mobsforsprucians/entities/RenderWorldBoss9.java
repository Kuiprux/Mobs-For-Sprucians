...
public class RenderWorldBoss9 extends RenderBiped{
	
	public static void renderEntity() {
		RenderingRegistry.registerEntityRenderingHandler(EntityWorldBoss9.class, new RenderWorldBoss9(new ModelBiped(), 1));
	}
	
	public RenderWorldBoss9(ModelBiped model, float shadowSize) {
