...
public class RenderWorldBoss5 extends RenderBiped{
	
	public static void renderEntity() {
		RenderingRegistry.registerEntityRenderingHandler(EntityWorldBoss5.class, new RenderWorldBoss5(new ModelBiped(), 1));
	}
	
	public RenderWorldBoss5(ModelBiped model, float shadowSize) {
