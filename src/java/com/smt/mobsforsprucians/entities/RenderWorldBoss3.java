...
public class RenderWorldBoss3 extends RenderBiped{
	
	public static void renderEntity() {
		RenderingRegistry.registerEntityRenderingHandler(EntityWorldBoss3.class, new RenderWorldBoss3(new ModelBiped(), 1));
	}
	
	public RenderWorldBoss3(ModelBiped model, float shadowSize) {
