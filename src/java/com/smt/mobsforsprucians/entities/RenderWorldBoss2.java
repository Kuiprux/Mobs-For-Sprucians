...
public class RenderWorldBoss2 extends RenderBiped{
	
	public static void renderEntity() {
		RenderingRegistry.registerEntityRenderingHandler(EntityWorldBoss2.class, new RenderWorldBoss2(new ModelBiped(), 1));
	}
	
	public RenderWorldBoss2(ModelBiped model, float shadowSize) {
