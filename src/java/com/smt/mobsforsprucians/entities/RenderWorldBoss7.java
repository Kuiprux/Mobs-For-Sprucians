...
public class RenderWorldBoss7 extends RenderBiped{
	
	public static void renderEntity() {
		RenderingRegistry.registerEntityRenderingHandler(EntityWorldBoss7.class, new RenderWorldBoss7(new ModelBiped(), 1));
	}
	
	public RenderWorldBoss7(ModelBiped model, float shadowSize) {
